        ...
        <div class="banner-home">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <img src="/images/pics/showcase.png" alt="Home Garage" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center mb-3">
                        <img src="images/pics/car-navigation.jpg" alt="PCEE ADAPTER" class="img-fluid rounded-3 mb-2">
                    ...
                    <div class="col-sm-4 text-center mb-3">
                        <img src="images/pics/car-24.jpg" alt="PCAPTER" class="img-fluid rounded-3 mb-2">
        ...
        <div class="">
            <div class="container py-5">
                ...
                <div class="row align-items-center ">
                    ...
                    <div class="col-sm-5">
                        <div class="">
                            <img src="images/pics/phone.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
